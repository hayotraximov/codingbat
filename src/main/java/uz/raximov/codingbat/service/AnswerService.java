...
import uz.raximov.codingbat.repository.AnswerRepository;
...
public class AnswerService {
    ...
    public ApiResponse getById(Integer id){
        ...
        return byId.map(answer -> new ApiResponse("Answer topildi", true, answer)).orElseGet(() -> new ApiResponse("Answer topilmadi", false, null));
    }
}
